...
func ipaddrTest(t *testing.T, cktype int, dataset map[string]bool, errfmt string) {
	// Test each dataset entry against the IP type
...
func Test_strutils_IPAddr(t *testing.T) {
	...
	// Test IPv4 addresses with CIDR notation
	...
	// Test IPv6 addresses with CIDR notation
	...
	// Test IPv4-mapped embedded IPv6 addresses
	...
	// Test IPv4-mapped embedded IPv6 addresses with CIDR notation
	...
	// Test each address type against the validation function
...
func Test_strutils_MacAddr(t *testing.T) {
	...
	// Test invalid MAC address should return false
...
func Test_strutils_PureTextNormal(t *testing.T) {
	...
	// Test each text validation for normal mode
...
func Test_strutils_PureTextStrict(t *testing.T) {
	...
	// Test each text validation for strict mode
	for k, v := range testTxts {
...
func Test_strutils_FilePathOnlyFilePath(t *testing.T) {
	...
	// Test each file path validation
...
func Test_strutils_FilePathAllowRelativePath(t *testing.T) {
	...
	// Test each file path validation with relative paths
	for k, v := range testFilepaths {
